  ...
  Widget build(BuildContext context) => Column(
        ...
        children: [
          ...
          if (extraLabel != null)
            Text(
              extraLabel ?? "",
              style: extraLabelStyle ?? kBodyLarge.copyWith(color: kTextColorLight),
            ),
          if (extraLabel != null)
            const SizedBox(
              height: 0,
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              border: const UnderlineInputBorder(
                  borderSide: BorderSide(color: kDisabledColor)),
              // ********** focusedBorder ********
              focusColor: kPrimaryColor,
              ...
              // ********** label ********
              label: label,
              labelStyle: labelStyle ?? kBodyLarge.copyWith(color: kTextColorLight),
            ),
            // ********** inputFormatters ********
            inputFormatters:
                inputFormatters ?? [LengthLimitingTextInputFormatter(40)],
